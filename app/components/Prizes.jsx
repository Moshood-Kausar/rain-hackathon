    ...
    <section id='prizes' className="px-4 md:px-10 lg:px-20 mb-[14px]">
        ...
        <div className='order-0 md:order-1 lg:order-0 bg-primary rounded-lg max-w-[383px] px-3.5 xl:px-5 py-4 h-[calc(100%_-_16px)] md:h-[calc(100%_-_40px)] xl:h-[calc(100%_-_60px)] xl:my-auto'>
                ...
                <div className='mt-[15px] mb-4 md:mb-[50px] md:px-5 text-dark'>
                    <h3 className='flex mx-auto w-fit items-center text-center text-[32px] font-medium'>750,000 <span className='ml-2 text-xl'>Naira</span></h3>
                    <p>Yes! You read that well. 750 thousand naira for the second team and that could also be YOUR team.</p>
                </div>
        </div>
        <div className="order-0 xl:order-1 p-[2px] md:col-span-2 xl:col-span-1 mx-auto w-fit h-fit rounded-lg bg-gradient-to-r from-[#95772B] via-[#4C4E1C] to-[#666828]">
            <div className="bg-white bg-[url('/stars.png')] border-2 rounded-md max-w-[380px] px-3.5 md:px-6">
                <div className='mt-[14px] mb-4 flex items-center justify-between'>
                    <div className={`flex items-center gap-2 text-xl font-medium`}>
                        <Image src={gold} alt='Gold Medal' width={180} height={143} className='w-[60px] h-auto' />
                        Winner!
                    </div>
                    <div>
                        <Image src={trophy} alt='Trophy' width={295} height={253} className='w-[90px] sm:w-[98px] h-auto' />
                    </div>
                </div>
                <div className='mb-5 md:mb-[66px] md:px-5'>
                    <h3 className='flex mx-auto w-fit items-center text-center text-[32px] font-medium'>1,000,000 <span className='ml-2 text-xl'>Naira</span></h3>
                    <p>Yes! You read that well. 1 million naira for the first team and that could be YOUR team.</p>
                </div>
            </div>
        </div>
        <div className=' md:order-1 lg:order-0 bg-primary rounded-lg max-w-[383px] px-3.5 xl:px-5 py-4 h-[calc(100%_-_16px)] md:h-[calc(100%_-_40px)] xl:h-[calc(100%_-_60px)] xl:my-auto'>
                ...
                <div className='mt-[15px] mb-4 md:mb-[50px] md:px-5 text-dark'>
                    <h3 className='flex mx-auto w-fit items-center text-center text-[32px] font-medium'>500,000 <span className='ml-2 text-xl'>Naira</span></h3>
                    <p>Yes! You read that well. 500 thousand naira for the second team and that could also be YOUR team.</p>
                </div>
        </div>
        </div>
    </section>
